...
static function i_inicializacao
   ...
   cTITULO := "RAZAO CONTABIL POR CENTROS DE CUSTOS - NO MES "+cMESANO+"."
...
static function i_subcabec
   ...
   @ prow()+1,00 say LANC->Centro + " - " + CCUSTO->Descricao
   @ prow()+1,00 say " Data| Lcto|   Lote   | Filial|                   Historico                                       |      Debito     |     Credito     "
...
static function i_imp_lanc
   ...
   for nCONT = 1 to len(aLANC)
       ...
       do while nCONTA <= len(aLANC[nCONT,4])
          ...
          @ prow(),031 say subs(aLANC[nCONT,4],nCONTA,59)
          nCONTA+=66
