...
// OBJETIVO...: RECIBO DE ENTREGA DE VALES CESTA BASICA
// ANALISTA...:
...
//      endif
      ...
      FUN->(dbSetRelation("LANC",{|| cANOMES+FUN->Matricula+cTIPOREL+'457'},"cANOMES+FUN->Matricula+cTIPOREL+'457'}"))
      ...
      if nTOT_VAL <> 0 .or. nQTD_VAL <> 0
         ...
         @ prow()+1,00 say "|" +XAEXPAN+ space(10) + "     CESTA BASICA   " + XDEXPAN + space(18) + "|"
         @ prow()+1,00 say "|" + space(78) + "|"
         @ prow()+1,00 say "|" + space(10) + "Recebi de " + XRAZAO + space(8) + "|"
         @ prow()+1,00 say "| o total de " + transform(nQTD_VAL,"@R 999") + " cesta  basica no valor de  R$    "+ transform(nTOT_VAL,"@R 9,999,999.99") + space(17) + "|"
