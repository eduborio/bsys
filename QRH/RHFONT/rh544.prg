...
do while .T.
   ...
   qgetx(9,30,@nJUROS,"@E 999,999.99")
   qgetx(10,30,@nBC_INSS,"@E 999,999.99")
   qgetx(11,30,@nCOMP,"@E 999,999.99")
   cLOCALIMP := ""
...
//Campo 6-VALOR DO INSS .........................................
   ...
   if CONFIG->Gr_simples != "S"
      @ prow()  ,105 say nBC_INSS picture cPIC
   Else
      @ prow()  ,105 say nBC_INSS picture cPIC
   Endif
//...............................................................
...
//Campo 9-VALOR DE OUTRAS ENTIDADES....................
   ...
   if CONFIG->Gr_simples != "S"
      @ prow()+2,105 say nCOMP picture cPIC
   else
...
//.....................................................
   ...
   if nJUROS > 0
      @ prow()+2,105 say nJUROS picture cPIC
   else
      @ prow()+2,105 say " "
   endif
   ...
   if CONFIG->Gr_simples != "S"
      nSOMA :=  nBC_INSS + nCOMP + nJUROS
   else
      nSOMA :=  nBC_INSS + nCOMP + nJUROS
   endif

//Campo 11-TOTAL......................................
   @ prow()+2,105 say round(nSOMA,2) picture cPIC
//....................................................
