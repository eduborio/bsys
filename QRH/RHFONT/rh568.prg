...
//      endif
      ...
      FUN->(dbSetRelation("LANC",{|| cANOMES+FUN->Matricula+cTIPOREL+'456'},"cANOMES+FUN->Matricula+cTIPOREL+'456'}"))
      ...
      if nTOT_VAL <> 0 .or. nQTD_VAL <> 0
         ...
         @ prow()+1,00 say "|" +XAEXPAN+ space(10) + "      VALE MERCADO  " + XDEXPAN + space(18) + "|"
         @ prow()+1,00 say "|" + space(78) + "|"
         @ prow()+1,00 say "|" + space(10) + "Recebi de " + XRAZAO + space(8) + "|"
         @ prow()+1,00 say "| o total de " + transform(nQTD_VAL,"@R 999") + " vale(s) Mercado no valor de R$   "+ transform(nTOT_VAL,"@R 9,999,999.99") + space(17) + "|"
