...
MOV_PROJ->(dbSetFilter({|| Tipo == "SA" }, 'Tipo == "SA" '))
...
static function i_edicao
   ...
   if cOPCAO <> "I"
      ...
      qrsay ( XNIVEL++ , MOV_PROJ->Preco_alug,"@E 999.999,99")
...
static function i_exclusao
   if qconf("Confirma exclus„o desta Saida de Aluguel ?")
      if MOV_PROJ->(qrlock())
         PROD->(Dbsetorder(4))
         INVENT->(Dbsetorder(4))
