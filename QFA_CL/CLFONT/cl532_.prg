...
private sBLOC1 := qlbloc("B532B","QBLOC.GLO") // ordem de impressao
...
static function i_inicializacao
   ...
   cTITULO := "LISTAGEM DA TABELA DE PRECOS  "
...
static function i_impressao
   ...
   do while ! PROD->(eof())   // condicao principal de loop
      ...
      if XPAGINA == 0 .or. prow() > K_MAX_LIN
         ...
         @ prow()+1,0 say "DESCRICAO                                                       PRECO CONSUMIDOR"
   ...
   //      @ prow()  ,48 say transform(PROD->Preco_at,"@E 999,999.99" )
         @ prow()  ,65 say transform(PROD->Preco_cons,"@E 999,999.99" )
