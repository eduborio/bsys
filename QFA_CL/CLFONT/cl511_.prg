...
static function i_inicializacao
   ...
   cTITULO := "LISTAGEM DE NOTAS FISCAIS CANCELADAS" +" de " + dtoc(dINI) + " a " + dtoc(dFIM)
...
static function i_impressao
   ...
   do while ! FAT->(eof())  .and. FAT->Dt_emissao >= dINI .and. FAT->Dt_emissao <= dFIM  // condicao principal de loop
      ...
      if XPAGINA == 0 .or. prow() > K_MAX_LIN
         ...
         @ prow()+1,0 say XCOND1 + "Numero  Cliente                                                            Emissao         Valor da Nota "
         @ prow()+1,0 say ""
      endif
      ...
      qmensa("Aguarde... Processando ...")
         ...
         @ prow()  ,94  say transform(nVAL_PED, "@E 9,999,999.99")
         nTOTAL += nVAL_PED
         nVAL_PED := 0
         nIPI     := 0
         nDESC    := 0
