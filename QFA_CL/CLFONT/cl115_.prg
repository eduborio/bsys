...
PROD->(qview({{"Cod_ass/Codigo Ass"                       ,3},;
             ...
             {"transform(E112_7   , '@e 999,999.99')/Pre‡o a vista" ,0}},"P",;
             {NIL,"c115a",NIL,NIL},;
...
static function i_edicao
   ...
   if cOPCAO == "C"
      ...
      qrsay ( XNIVEL++ , PROD->E112_7,    "@E 999,999.99" )
      qrsay ( XNIVEL++ , PROD->E112_36 ,  "@E 999,999.99" )
      qrsay ( XNIVEL++ , PROD->E112_369 , "@E 999,999.99" )
      qrsay ( XNIVEL++ , PROD->E112_36912,"@E 999,999.99" )
      qrsay ( XNIVEL++ , PROD->E112_SEM , "@E 999,999.99" )
      qrsay ( XNIVEL++ , PROD->E112_COMIS, "@E 99.99" )
...
static function i_edita_preco
   ...
   nVAL_7     := PROD->E112_7
   nVAL_36    := PROD->E112_36
   nVAL_369   := PROD->E112_369
   nVAL_36912 := PROD->E112_36912
   nVAL_SEM   := PROD->E112_SEM
   nVAL_COMIS := PROD->E112_COMIS
   ...
   if qconf("Confirma a altera‡„o destes valores ?")
      if PROD->(qrlock())
         replace PROD->E112_7     with nVAL_7
         replace PROD->E112_36    with nVAL_36
         replace PROD->E112_369   with nVAL_369
         replace PROD->E112_36912 with nVAL_36912
         replace PROD->E112_SEM   with nVAL_SEM
         replace PROD->E112_COMIS with nVAL_COMIS
